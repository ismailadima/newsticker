...
class RunningTextAutoPublishGtv extends Command
{
     ...
     * @var string
     */
    protected $signature = 'autopublish:gtv';
    ...
    public function handle()
    {
        ...
        $autoPublishContentToday = $this->runningTextCommandInterface->autoPublishContentToday(Unit::UNIT_GTV);
