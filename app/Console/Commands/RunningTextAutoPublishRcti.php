...
class RunningTextAutoPublishRcti extends Command
{
     ...
     * @var string
     */
    protected $signature = 'autopublish:rcti';
    ...
    public function handle()
    {
        ...
        $autoPublishContentToday = $this->runningTextCommandInterface->autoPublishContentToday(Unit::UNIT_RCTI);
