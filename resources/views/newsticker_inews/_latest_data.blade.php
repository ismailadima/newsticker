<ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <!-- INEWS -->
        @if(!empty($latest_data[2])) 
        <li class="nav-item">
            <a class="nav-link" id="inews-tab" data-toggle="tab" href="#inews" role="tab" aria-controls="inews" aria-selected="false">Latest Newsticker INEWS</a>
        </li>
        @endif
...
<div class="tab-content" id="myTabContent">
    ...
    <!-- INEWS -->
    @if(!empty($latest_data[2])) 
    <div class="tab-pane fade" id="inews" role="tabpanel" aria-labelledby="inews-tab">
        @php 
        $news = !empty($latest_data[2]['inews']) ? $latest_data[2]['news'] : null;
        $all_merge = !empty($latest_data[2]['all_merge']) ? $latest_data[2]['all_merge'] : null;
        $infotainment = !empty($latest_data[2]['infotainment']) ? $latest_data[2]['infotainment'] : null;
        $promo1 = !empty($latest_data[2]['promo']['promo1']) ? $latest_data[2]['promo']['promo1'] : null;
        $promo2 = !empty($latest_data[2]['promo']['promo2']) ? $latest_data[2]['promo']['promo2'] : null;
        @endphp

        @if(!empty($all_merge))
        <div class="card">
            <div class="card-body">
            <h5 class="card-title"><b>Inews Merge</b></h5>
            <h6 class="card-subtitle mb-2 text-muted"></h6>
            {{-- <p class="card-text"> {{$news}} </p> --}}
            <textarea name="" readonly class="form-control" id="contentModalLatest" cols="50" rows="19">{{$all_merge}}</textarea>
