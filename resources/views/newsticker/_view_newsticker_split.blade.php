...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="20%">
                <button type="button" data-index-data="{{$key}}" data-id-table="{{$idDeleted}}" data-type-content="1" class="btn btn-info mb-2 updateLineBtn"> <i class="fa fa-save"></i> Update Line </button>
                <button type="button" data-index-data="{{$key}}"  data-id-table="{{$idDeleted}}" data-type-content="1" class="btn btn-danger mb-2 deleteLineBtn"> <i class="fa fa-trash"></i> Delete Line </button>
            </td>
        </tr>
        @endforeach
...
<table class="table table-bordered table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td width="20%">
                <button type="button" data-index-data="{{$key}}" data-id-table="{{$idDeleted}}" data-type-content="2" class="btn btn-info mb-2 updateLineBtn"> <i class="fa fa-save"></i> Update Line </button>
                <button type="button" data-index-data="{{$key}}" data-id-table="{{$idDeleted}}" data-type-content="2" class="btn btn-danger deleteLineBtn"> <i class="fa fa-trash"></i> Delete Line </button>
            </td>
        </tr>
        @endforeach
