    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Newstickers</h6>
            </div>
            <div class="card-body">
                ...
                <form action="/newstickers/store" method="post" name="form_upload" id="form_upload" enctype="multipart/form-data">
                    ...
                    <div class="row form-group" style="display: none" id="div_file_upload2">
                        ...
                        <div class="col-sm-8">
                            <input type="file" class="form-control" accept=".txt" name="file_upload2" id="file_upload2">
                        </div>
...
@section('script')
    <script src="/js/newsticker/create.js"></script>
@endsection