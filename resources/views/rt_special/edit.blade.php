        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form action="/rt_special/store" method="post" name="form_upload" id="form_upload" enctype="multipart/form-data">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-4">
                            <label class="form-label" for="program_tv_name">Program Name</label>
                        </div>

                        <div class="col-sm-8">
                            <input type="text" required class="form-control" name="program_tv_name" id="program_tv_name" value="{{ $newsticker->program_tv_name }}">
                        </div>
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-contentsplit" role="tabpanel" aria-labelledby="nav-contentsplit-tab">
                            <div class="mt-3"></div>
                            @include('rt_special._view_newsticker_split')
...
@section('script')
    <script src="/js/rt_special/edit.js"></script>
@endsection